...
<head>
  <meta charset="UTF-8">
  <title>Halaman Unduh Data</title>
  ...
  <div class="row">
    ...
    <div class="col-md-10">
      ...
      <div class="d-flex align-items-center mt-3 mb-3">
        <a href="<?= base_url('home') ?>" class="btn btn-secondary me-3">⬅ KEMBALI</a>
        <form action="<?= base_url('user/unduh') ?>" method="get" class="d-flex align-items-center">
          ...
          <div class="card shadow-sm border-0 p-3 h-100" style="background-color: #dcdcdc">
            ...
            <div class="d-flex justify-content-end">
              <?php if ($item['status'] == 'Lengkap'): ?>
                <a href="<?= base_url('unduh/pdf/' . $item['bulan'] . '/' . $tahun) ?>" class="btn btn-success btn-sm">⬇️ Unduh PDF</a>
              <?php else: ?>
